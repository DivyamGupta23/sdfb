...
public class SampleWebView : MonoBehaviour
{
    ...
    IEnumerator Start()
    {
        ...
        webViewObject.SetMargins(5, 100, 5, 0);
    ...
    void OnGUI()
    {
        ...
        if (GUI.Button(new Rect(x, 30, 80, 50), "Back")) {
        ...
        if (GUI.Button(new Rect(x, 30, 120, 50), "Back to Campus")) {
             {
                SceneManager.LoadScene("eduroom 1");
             }
        }
        x += 90;
